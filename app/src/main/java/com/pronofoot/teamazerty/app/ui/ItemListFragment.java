...
public abstract class ItemListFragment<E> extends SherlockFragment
    ...
    public void onCreateOptionsMenu(Menu optionsMenu, MenuInflater inflater) {
        inflater.inflate(R.menu.principal, optionsMenu);
    }
    ...
    private void goToReglement() {
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(Constants.Http.REGLEMENT));
        startActivity(browserIntent);
    }

    private void goToForum() {
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(Constants.Http.FORUM_PRONOFOOT));
        startActivity(browserIntent);
    }

    private void goToProfile() {
        Intent profile = new Intent(getActivity().getApplicationContext(), ProfilActivity.class);
        startActivity(profile);
    }

    public abstract LogoutService getLogoutService();
